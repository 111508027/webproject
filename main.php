...
<div id="id02" class="modal">
  ...
  <form class="modal-content animate"  method="post" onsubmit = "checkall()" action="main.php">
    <div class="imgcontainer">
    ...
    <div class="container">
      ...
      <input type="text" placeholder="Enter Username" name="userName" id="userName" onkeyup="checkname();" required>
	  ...
	  <input type = "number"  name = "contact"  placeholder = "Phone No" maxlength = "10" id="contact" onkeyup="checkcontact();" required>
